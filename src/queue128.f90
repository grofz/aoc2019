!
! Procedures that implement the simple queue (8 byte integers version)
!
  ...
  contains
    ...
    type(queue_t) function queue_new(arr, maxsize) result(this)
      integer(IXB), intent(in), optional :: arr(:)
